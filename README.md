...
- [Ubuntu](https://cdimage.ubuntu.com/releases/plucky/release/ubuntu-25.04-preinstalled-server-riscv64+licheerv.img.xz) - Ubuntu image, compatible with the MangoPi MQ Pro
